...
(function(global, factory) {
  ...
  var defaultsOptions = {
    ...
    postTemplate: '<div class="item post <%= options.defaultExpansion %>" data-timestamp="<%= data.timestamp %>"> \
        <div class="inner <%= data.innerclass %>"> \
          <div class="title"> \
            <h3> \
          ...
          <div class="body"> \
            ...
            <% } %> \
            <% if (data.body) { %>  \
              <div class="text"><div><%= data.body %></div><label style="float: right;margin-right: 20px;"><%= data.up %></label><span class="up glyphicon glyphicon-thumbs-up" style="float: right;"></span><\/div> \
            <% } %> \
            <div class="clearfix"> \
              <% if (data.read_more_url) { %> \
                <a target="_blank" class="more" href="<%= data.read_more_url %>">更新词条<\/a> \
              <% } %> \
            <\/div> \
          <\/div> \
    ...
    buttonTemplate: '<div class="vertical-timeline-buttons clearfix"> \
        <div class="expand-collapse-buttons"> \
          <a class="expand-all <% if (data.defaultExpansion == "expanded") { %>active<% } %>" href="#"><span>全部展开<\/span><\/a> \
          <a class="collapse-all <% if (data.defaultExpansion == "collapsed") { %>active<% } %>" href="#"><span>全部收回<\/span><\/a> \
        <\/div> \
        <div class="sort-buttons"> \
          <a class="sort-newest <% if (data.defaultDirection == "newest") { %>active<% } %>" href="#"><span>倒序<\/span><\/a> \
          <a class="sort-oldest <% if (data.defaultDirection == "oldest") { %>active<% } %>" href="#"><span>正序<\/span><\/a> \
        <\/div> \
      <\/div> \
    ',
